...
- **Around 8 million realistic personal identities** for immense variety.
...
### 🧑‍⚕️ Healthcare / Provider Info Generator
  - **Around 500,000** realistic provider profile combinations
...
2: Click the "**Install TransShield**" button to install the script!
    [![Install TransShield](https://img.shields.io/badge/Install%20TransShield-Userscript-blue?logo=Tampermonkey)](https://cdn.jsdelivr.net/gh/kirbysoftware/transshield@main/TransShield-V1.2-hotfix.user.js)
...
- Researching a captcha bypass (may never be implemented)
...
- The script does not currently support captcha solving. So **Manual input is required**.
